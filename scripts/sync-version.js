...
// plugin manifests so they all stay in sync, then stages the changes so they
...
execSync('git add src/cli.ts .claude-plugin/plugin.json .claude-plugin/marketplace.json')
